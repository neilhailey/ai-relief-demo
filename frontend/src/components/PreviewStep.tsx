  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 24, padding: '32px 24px' }}>
      <div style={{ textAlign: 'center' }}>
        <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 6 }}>{t.previewLead}</h1>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            width: 32, height: 32, borderRadius: 6, background: 'var(--border)',
      ...
      <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 'var(--radius)', color: '#fff', fontSize: 14, fontWeight: 600,
            display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer',
          }}
        >{t.createModel}</button>
      </div>

      <div style={{ fontSize: 11, color: 'var(--muted)', textAlign: 'center' }}>{t.previewNote}</div>
    </div>
  )
}
